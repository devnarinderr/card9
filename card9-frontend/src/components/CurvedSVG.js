...
CurvedSVG.propTypes = {
  color: PropTypes.oneOfType([PropTypes.element, PropTypes.string]),
};

export default function CurvedSVG({ color, ...other }) {
  return (
    <svg {...other} preserveAspectRatio="xMinYMax meet" viewBox="0 0 246 57">
      <path
